        ...
        >
          ...
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-primary rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-lg sm:text-xl" style={{ fontFamily: 'Ballet, cursive' }}>H</span>
            </div>
            <span className="text-portfolio-text font-semibold text-lg sm:text-xl tracking-wide">HexaCode</span>
          </motion.div>
          ...
          >
            <span>© 2025 Designed & Developed by HexaCode</span>
            <motion.div
              animate={{ 
                scale: [1, 1.2, 1],
                rotate: [0, 5, -5, 0]
