...
const Hero = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/HexaCode" },
    { icon: Linkedin, href: "https://www.linkedin.com/company/hexacode" },
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-4 lg:gap-3 items-center">
          ...
          >
            ...
            >
              Building next-generation decentralized solutions with smart contracts, Web3 applications, and blockchain infrastructure. Transforming ideas into secure, scalable DeFi and NFT ecosystems.
            </motion.p>
