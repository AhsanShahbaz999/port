...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    { icon: Github, href: "https://github.com/HexaCode", label: "GitHub" },
    { icon: Linkedin, href: "https://www.linkedin.com/company/hexacode", label: "LinkedIn" }
  ];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const mailtoLink = `mailto:contact@hexacode.dev?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(emailBody)}`;
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-portfolio-text-muted max-w-xl sm:max-w-2xl mx-auto px-4 sm:px-0">
            We build secure, scalable blockchain solutions and Web3 applications. 
            Let's transform your vision into decentralized reality!
          </p>
        </motion.div>
